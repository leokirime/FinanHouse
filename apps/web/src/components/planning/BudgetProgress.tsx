 ...
 * apenas dela: `CategoryBudgetList` sempre exibe `statusLabel` em texto ao
 * lado. A largura é limitada a 100% mesmo quando o percentual real excede
 * isso (categoria excedida), para a barra continuar informativa.
 */
