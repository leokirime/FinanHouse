...
| `bloco_04_validacao_tls_e_revisao_pre_migration` | Validação TLS e revisão pré-migration | Concluído com ressalvas — TLS não ativo (P2), migration revisada e ainda não aplicada |
