...
| `bloco_10_historico_mensal_somente_leitura_com_estado_em_memoria` | Histórico mensal somente leitura com estado em memória | Concluído — integrado à `main` em `fd026da` (última rodada planejada; nenhum bloco novo criado depois) |
