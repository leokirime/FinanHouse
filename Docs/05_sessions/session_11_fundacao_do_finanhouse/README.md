...
| `bloco_07_movimentacoes_funcionais_com_estado_em_memoria` | Movimentações funcionais com estado em memória | Concluído (branch própria, ainda não integrada à `main`) |
