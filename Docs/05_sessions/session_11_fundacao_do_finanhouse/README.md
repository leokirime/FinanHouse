...
| `bloco_13_integridade_composta_do_membro_responsavel` | Integridade composta do membro responsável | Concluído — migration incremental `0001` aplicada em `finanhouse_dev` em 2026-07-31, após recuperação de um estado parcial (erro MySQL 3823, ver DT-09); FK composta com `ON DELETE RESTRICT` + CHECK; P2 do membro responsável encerrada |
