...
Todas as tabelas têm `created_at`/`updated_at` (TIMESTAMP). Detalhes completos, índices e regras: `database/proposed-schema/`. `category_budgets` aplicada a `finanhouse_dev` em 2026-08-04 (Bloco 18, DT-13).
